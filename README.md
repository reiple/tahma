...
모든 수정 사항은 새 브랜치에서 작업하고 원격 저장소에 풀 리퀘스트를 작성합니다. 풀 리퀘스트 제목과 본문은 한국어로 작성하며, 작성 시 Copilot 리뷰를 요청합니다. Copilot 리뷰가 완료되면 내용을 검토하고 필요한 수정 사항을 반영한 뒤, 코드 리뷰를 거쳐 `main`에 반영합니다.
